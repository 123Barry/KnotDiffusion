...
def main(args):
    ...
    if args.debug:
        metadata_file_name = 'knot_metadata_debug.csv'
    else:
        metadata_file_name = 'knot_metadata.csv'
    meta_dir = os.path.dirname(write_dir)
    metadata_path = os.path.join(meta_dir, metadata_file_name)
